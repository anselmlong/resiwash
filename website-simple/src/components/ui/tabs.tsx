...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-md bg-dark-surface p-1 text-dark-text-secondary dark:bg-light-surface dark:text-light-text-secondary',
      className
    )}
    {...props}
  />
